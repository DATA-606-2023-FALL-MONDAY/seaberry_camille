...
def main(run: str, model_type: str, dataset: str, project_dir: str,
         data_name: str, tune_epochs: int, train_epochs: int, batch: int,
         iterations: int, train: bool, val: bool, no_log: bool, label: str):
